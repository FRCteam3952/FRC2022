...
public class Autonomous extends CommandBase {
  ...
  public Autonomous(DriveTrain drive, ClimberHooks hooks, ClimberArm arm, Shooter shooter, BottomIndexer bottomIndexer,
      TopIndexer topIndexer) {
